...
public class Movement {
   ...
   static int counter = 0;
    ...
    public static void main(String[] args) throws IsEmptyException, TpMovCaballo.IsEmptyException {
    ...
    private static void menu() throws IsEmptyException, TpMovCaballo.IsEmptyException {
