...
public class BinarySearchTree <T>{
    ...
    public void insert(java.lang.Comparable<T> x){
        root = insert(root, x);
    }


    // precondicion: elemento a eliminar pertenece al árbol
    public void delete(java.lang.Comparable<T> x) throws IsEmptyException {
        root = delete(root, x);
    }
    ...
    public T search(java.lang.Comparable<T> x) throws IsEmptyException {
        return search(root, x).elem;
    }

    // precondicion: -
    public boolean exists(java.lang.Comparable<T> x) throws IsEmptyException {
    ...
    private NodoDoble<T> search(NodoDoble<T> t, java.lang.Comparable<T> x) throws IsEmptyException {
    ...
    private boolean exists(NodoDoble<T> t, java.lang.Comparable<T> x) throws IsEmptyException {
        if (isEmpty()){
            throw new IsEmptyException();
        }
        if (t == null)
    ...
    private NodoDoble<T> insert (NodoDoble<T> t, java.lang.Comparable<T> x) {
        if (t == null){
            t = new NodoDoble<T>();
            t.elem = (T) x;
    ...
    private NodoDoble<T> delete (NodoDoble<T> t, java.lang.Comparable<T> x) throws IsEmptyException {
        if (isEmpty()){
            throw new IsEmptyException();
        }
        if (x.compareTo(t.elem) < 0)
    ...
    public int getNumberOfComparisons(java.lang.Comparable<T> x) throws IsEmptyException {
        counterOfSearchs = 0;
        search(x);
